...
```{r}
sb_slo <- pl_mod %>% filter(CTFIP == "SANTA BARBARA" | CTFIP == "SAN LUIS OBISPO")
...
Apparently, the arrival/departure times should NOT be NA'S. They should be 0's. Going back to the creation of the arrival and departure times in this format. THis is in the script 
